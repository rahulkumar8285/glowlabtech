...
export default function ProductsPage({
  ...
  useEffect(() => {
    const cleanup = updatePageSEO({
      title: 'GeoProof — GPS Field Force Tracking & Work Validation | GlowLab Tech',
      description:
  ...
  return (
    <div id="products-page" className="w-full bg-[#FAF9F6] text-[#1A1A1A]">
      ...
      <PageHeader
        id="products-header"
        title="Field Force Platforms & / Proprietary SaaS Engines."
        ...
        <div className="w-full max-w-7xl mx-auto px-5 sm:px-12 md:px-16 lg:px-20">
          ...
          <div className="border border-black/10 bg-white rounded-2xl p-6 sm:p-10 md:p-12 shadow-[0_4px_30px_rgba(0,0,0,0.03)] relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-2 mb-8 relative z-10">
              <a
                href={primaryProduct.trialCta?.ctaUrl || 'https://www.geoproof.in/'}
                target="_blank"
              ...
              >
                <span>Try GeoProof Free for 14 Days</span>
        ...
        <div className="w-full max-w-7xl mx-auto px-5 sm:px-12 md:px-16 lg:px-20">
          <div className="max-w-3xl mb-12 sm:mb-16">
            ...
            <p className="font-body text-sm sm:text-base text-neutral-600 mt-3 leading-relaxed">
              Eliminate hearsay and manual paperwork. GeoProof gives your leadership direct visibility into active routes, verified client meetings, and tamper-proof work execution across all Indian territories.
            </p>
          </div>
                ...
                {module.link && module.linkText ? (
                  <div className="pt-4 border-t border-black/10">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 font-body text-xs sm:text-sm font-semibold text-[#C84826] hover:text-[#9E3416] transition-colors"
                    >
      ...
      {primaryProduct.whyNeeded && (
        ...
        >
          <div className="w-full max-w-7xl mx-auto px-5 sm:px-12 md:px-16 lg:px-20">
            ...
            {/* Contrast Grid: Pain Points vs. GeoProof Solution */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              {/* Without GeoProof (Pain Points) */}
              ...
              {/* With GeoProof (Transformative Outcomes) */}
              <div className="bg-[#141413] text-[#FAF9F6] rounded-2xl p-6 sm:p-8 relative border border-white/10 shadow-lg">
                <div className="flex items-center gap-2 text-[#FAF9F6] font-headline font-medium text-base sm:text-lg mb-4">
                  ...
                  <span>The GeoProof Field Accountability System</span>
                </div>
        ...
        >
          <div className="w-full max-w-7xl mx-auto px-5 sm:px-12 md:px-16 lg:px-20">
            <div className="max-w-3xl mb-12 sm:mb-16">
              ...
              <p className="font-body text-sm sm:text-base text-neutral-600 mt-3 leading-relaxed">
                Whether you oversee pharmaceutical territory managers, solar technicians, or outdoor media audit teams, GeoProof adapts directly to your operational SOPs.
              </p>
            </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3 font-body text-xs sm:text-sm">
                      ...
                      <div className="text-neutral-800">
                        <span className="font-medium text-[#C84826] block mb-0.5">GeoProof Solution:</span>
                        {ind.solution}
                      </div>
                    </div>
                  </div>
        ...
        >
          <div className="w-full max-w-7xl mx-auto px-5 sm:px-12 md:px-16 lg:px-20">
            <div className="max-w-3xl mb-12 sm:mb-16">
              ...
              <h2 className="font-headline font-semibold text-2xl sm:text-4xl text-[#1A1A1A] tracking-tight leading-tight">
                Evaluate GeoProof for your specific team workflow and operational needs.
              </h2>
              <p className="font-body text-sm sm:text-base text-neutral-600 mt-3 leading-relaxed">
              ...
              {primaryProduct.buyerGuides.map((guide) => (
                ...
                >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 font-body text-xs font-semibold text-[#C84826] hover:text-[#9E3416] transition-colors pt-3 border-t border-black/5"
                  >
      ...
      {/* SECTION 6: HIGH-CONVERTING 14-DAY FREE TRIAL CTA */}
